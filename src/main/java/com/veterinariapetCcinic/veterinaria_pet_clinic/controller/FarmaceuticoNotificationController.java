...
@RestController
@RequestMapping("/farmaceutico/api/ui-notifications")
public class FarmaceuticoNotificationController {

    private final NotificacionService notificacionService;

    public FarmaceuticoNotificationController(NotificacionService notificacionService) {
